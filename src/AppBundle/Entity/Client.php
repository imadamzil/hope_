...
class Client
{
    ...
    private $missions;
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Projet", mappedBy="client",cascade={"persist", "remove"})
     */
    private $projets;
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Production", mappedBy="client",cascade={"persist", "remove"})
     */
    private $productions;
